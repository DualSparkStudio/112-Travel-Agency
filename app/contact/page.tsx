            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-12 h-12 bg-teal-blue rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-charcoal/70">info@travelagency.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-charcoal/70">123 Travel St, City, Country</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a
                    ...
                    className="w-12 h-12 bg-teal-blue rounded-lg flex items-center justify-center text-white hover:bg-sky-blue-dark transition-colors"
                  >
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
              ...
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-xl text-charcoal">Thank you! We'll get back to you soon.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button type="submit" className="w-full premium-btn">
                    Send Message
                  </button>
                </form>
              )}
